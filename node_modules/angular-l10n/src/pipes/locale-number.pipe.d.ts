...
export declare class LocaleDecimalPipe implements PipeTransform {
    transform(value: any, defaultLocale: string, digits?: string): string | null;
}
...
export declare class LocaleCurrencyPipe implements PipeTransform {
    transform(value: any, defaultLocale: string, currency: string, symbolDisplay?: boolean, digits?: string): string | null;
}
