 ...
 * @author ptopczewski
 */
export declare class TerraUrlParamsDecorator {
    /**
     * set terra pager parameter to a given UrlSearchParams object
     * @param {URLSearchParams} urlSearchParams
     * @param {TerraPagerParameterInterface} terraPagerParameter
     */
    setTerraPagerParameter(urlSearchParams: URLSearchParams, terraPagerParameter: TerraPagerParameterInterface): void;
}
