...
export declare class TerraButtonWithOptionsComponent implements OnInit {
    private elementRef;
    /**
     ...
     *     the menu.
     */
    inputOptions: Array<TerraButtonInterface>;
    /**
     * @description Set the alignment of the context menu. Default right.
     */
    inputOptionsAlignment: TerraTextAlignEnum;
    private toggleButton;
    private _optionsToggle;
    private _alignRight;
    private clickListener;
    constructor(elementRef: ElementRef);
    ngOnInit(): void;
    private optionsClick(option);
