...
var TerraNodeTreeConfig = /** @class */ (function () {
    function TerraNodeTreeConfig(_translation) {
    ...
    TerraNodeTreeConfig.prototype.recursiveSetParent = function (list, parent) {
    ...
    TerraNodeTreeConfig.prototype.handleLazyLoading = function (node) {
        ...
        if (!node.hasLoaded && !util_1.isNullOrUndefined(node.onLazyLoad)) {
            ...
            node.onLazyLoad().subscribe(function () {
                ...
                node.isOpen = true;
                _this.setDefaultVisibilityToChildren(node.children);
            }, function () {
    ...
    TerraNodeTreeConfig.prototype.setDefaultVisibilityToChildren = function (nodeList) {
        var _this = this;
