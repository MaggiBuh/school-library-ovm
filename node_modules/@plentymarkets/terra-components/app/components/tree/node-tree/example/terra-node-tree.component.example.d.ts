...
export declare class TerraNodeTreeComponentExample implements OnInit {
    private _nodeTreeConfig;
    private nodeCounter;
    constructor(_nodeTreeConfig: TerraNodeTreeConfig<ExampleTreeData>);
    ngOnInit(): void;
