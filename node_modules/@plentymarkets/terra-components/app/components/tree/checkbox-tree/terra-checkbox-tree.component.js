...
var TerraCheckboxTreeComponent = /** @class */ (function (_super) {
    ...
    TerraCheckboxTreeComponent.prototype.getParentLeafState = function (leaf) {
        var parentLeafState = new ParentLeafState();
        for (var _i = 0, _a = leaf.subLeafList; _i < _a.length; _i++) {
            var subLeaf = _a[_i];
...
var ParentLeafState = /** @class */ (function () {
    function ParentLeafState() {
        this.allChildrenAreChecked = true;
        this.noChildrenAreChecked = true;
        this.isIndeterminate = false;
    }
    return ParentLeafState;
}());
exports.ParentLeafState = ParentLeafState;
