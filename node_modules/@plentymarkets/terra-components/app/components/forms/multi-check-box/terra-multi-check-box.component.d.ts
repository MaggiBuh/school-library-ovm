...
export declare class TerraMultiCheckBoxComponent implements OnInit, ControlValueAccessor {
    ...
    writeValue(valueList: Array<TerraMultiCheckBoxValueInterface>): void;
    registerOnChange(fn: any): void;
    registerOnTouched(fn: any): void;
    ngOnInit(): void;
    protected onHeaderCheckboxChange(isChecked: boolean): void;
    protected checkHeaderCheckboxState(): void;
    private changeHeaderCheckboxState(filteredLength);
