...
var TerraMultiSelectBoxComponent = /** @class */ (function () {
    function TerraMultiSelectBoxComponent(translation) {
        ...
        this._langPrefix = 'terraMultiSelectBox';
    ...
    Object.defineProperty(TerraMultiSelectBoxComponent.prototype, "inputSelectedValueList", {
        set: function (value) {
            ...
            if (value !== undefined && value != null) {
                ...
                for (var i = this._selectedValueList.length; i >= 0; i--) {
                ...
                this.inputValueList
                    ...
                    valueCopy_1.forEach(function (key) {
                        if (item.value == key) {
                            item.selected = true;
                            _this._selectedValueList.push(item.value);
                            return;
                        }
                    });
                });
                setTimeout(function () { return _this.inputSelectedValueListChange.emit(_this._selectedValueList); }, 0);
            }
        },
        enumerable: true,
        configurable: true
    ...
    TerraMultiSelectBoxComponent.prototype.ngOnInit = function () {
        ...
        if (!this.inputName) {
            ...
            this.translation.translationChanged.subscribe(function () {
                _this.inputName = _this.translation.translate(_this._langPrefix + '.selectAll');
            });
        }
        this._isInit = true;
    };
    ...
    TerraMultiSelectBoxComponent.prototype.changeValueState = function (isChecked, valueToChange) {
        ...
        var index = this._selectedValueList.indexOf(valueToChange.value);
        ...
        if (valueToChange.selected) {
            ...
            var index_1 = this._selectedValueList.indexOf(valueToChange.value);
            this._selectedValueList.splice(index_1, 1);
        }
    };
