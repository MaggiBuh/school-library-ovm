 ...
 * @author mscharf
 */
export declare class TerraFilterComponent implements OnInit {
    viewChildInputList: any;
    /**
     ...
     * */
    outputOnSearchBtnClicked: EventEmitter<any>;
    /**
     * @description Set the function which will be executed on click of the reset button.
     * */
    outputOnResetBtnClicked: EventEmitter<any>;
    /**
     * @description Set the function which will be executed on hitting enter.
     * */
    outputOnEnterSubmit: EventEmitter<any>;
    constructor();
    ngOnInit(): void;
    private searchBtnClicked();
    private resetBtnClicked();
    private onSubmit();
}
