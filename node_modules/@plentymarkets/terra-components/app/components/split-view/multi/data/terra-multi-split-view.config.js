            ...
            if (parent) {
                ...
                if (util_1.isNullOrUndefined(parent.children)) {
                    ...
                    for (var _i = 0, _a = parent.children; _i < _a.length; _i++) {
                        ...
                        var hasSameParameter = child.parameter && view.parameter &&
                            CircularJSON.stringify(child.parameter) === CircularJSON.stringify(view.parameter);
                        var hasSameInputs = child.inputs && view.inputs &&
                            CircularJSON.stringify(child.inputs) === CircularJSON.stringify(view.inputs);
                        var hasSameName = child.name === view.name;
                        var hasSameModule = child.module.ngModule === view.module.ngModule;
