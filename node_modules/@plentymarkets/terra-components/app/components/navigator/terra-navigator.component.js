...
var TerraNavigatorComponent = /** @class */ (function () {
    function TerraNavigatorComponent(_terraNavigatorSplitViewConfig, translation) {
    ...
    TerraNavigatorComponent.prototype.ngOnInit = function () {
        ...
        this._terraNavigatorSplitViewConfig.observableNodeClicked.subscribe(function (item) {
            ...
            if (!util_1.isNullOrUndefined(item.children)) {
                _this._terraNavigatorSplitViewConfig.modules[0].defaultWidth = 'col-xs-6 col-md-6 col-lg-6';
                ...
                while (_this._terraNavigatorSplitViewConfig.modules.length > item.rootPath.length) {
                    _this._terraNavigatorSplitViewConfig.modules.pop();
                }
    ...
    TerraNavigatorComponent.prototype.addSearchNode = function (node) {
        ...
        if (!util_1.isNullOrUndefined(node.children) && node.children.length > 0) {
            ...
            if (util_1.isNullOrUndefined(node.isVisible) || node.isVisible) {
