...
var TerraDataTableComponent = /** @class */ (function () {
    function TerraDataTableComponent() {
        ...
        this._langPrefix = 'terraDataTable';
        this._refTypeEnum = terra_ref_type_interface_1.TerraRefTypeEnum;
    ...
    TerraDataTableComponent.prototype.rowClicked = function (cell, row) {
    ...
    TerraDataTableComponent.prototype.deleteRow = function (rowToDelete) {
        var index = this.rowList.indexOf(rowToDelete);
    ...
    TerraDataTableComponent.prototype.doPaging = function (pagerData) {
        ...
        this._isHeaderCheckboxChecked = false;
        if (!util_1.isNullOrUndefined(this.rowList)) {
            this.rowList.forEach(function (row) {
    ...
    __decorate([
        ...
        __metadata("design:type", _1.TerraCheckboxComponent)
    ...
    __decorate([
        core_1.Input(),
        __metadata("design:type", Boolean)
    ], TerraDataTableComponent.prototype, "_hasCheckboxes", void 0);
