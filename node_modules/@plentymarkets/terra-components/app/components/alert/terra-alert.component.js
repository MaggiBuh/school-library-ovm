...
var TerraAlertComponent = /** @class */ (function () {
    function TerraAlertComponent() {
        this.alerts = [];
        if (!TerraAlertComponent_1._isCreating) {
    ...
    TerraAlertComponent.getInstance = function () {
        if (util_1.isNull(TerraAlertComponent_1._instance)) {
            TerraAlertComponent_1._isCreating = true;
            TerraAlertComponent_1._instance = new TerraAlertComponent_1();
            TerraAlertComponent_1._isCreating = false;
        }
        return TerraAlertComponent_1._instance;
    };
    ...
    TerraAlertComponent._instance = null;
