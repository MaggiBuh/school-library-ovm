...
var FileType = /** @class */ (function () {
    ...
    FileType.isWebImage = function (file) {
        if (path_helper_1.PathHelper.isDirectory(file)) {
            return false;
        }
        var extension = path_helper_1.PathHelper.extName(file);
        return [
            'jpg',
            'jpeg',
            'png',
    ...
    FileType.mapIconClass = function (file) {
        var extension = path_helper_1.PathHelper.extName(file);
        var iconMap = {
...
//# sourceMappingURL=fileType.helper.js.map
