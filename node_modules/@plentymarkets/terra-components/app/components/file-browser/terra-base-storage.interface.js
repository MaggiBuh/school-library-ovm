...
var TerraBaseMetadataStorageService = /** @class */ (function (_super) {
    __extends(TerraBaseMetadataStorageService, _super);
    function TerraBaseMetadataStorageService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return TerraBaseMetadataStorageService;
}(TerraBaseStorageService));
exports.TerraBaseMetadataStorageService = TerraBaseMetadataStorageService;
var TerraBasePrivateStorageService = /** @class */ (function (_super) {
    __extends(TerraBasePrivateStorageService, _super);
    function TerraBasePrivateStorageService() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    return TerraBasePrivateStorageService;
}(TerraBaseStorageService));
exports.TerraBasePrivateStorageService = TerraBasePrivateStorageService;
