...
var TerraStorageObject = /** @class */ (function () {
    ...
    Object.defineProperty(TerraStorageObject.prototype, "name", {
        get: function () {
            return path_helper_1.PathHelper.basename(this._s3Object.key);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TerraStorageObject.prototype, "icon", {
        get: function () {
            ...
            return fileType_helper_1.FileType.mapIconClass(this.name);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TerraStorageObject.prototype, "isDirectory", {
        get: function () {
            return path_helper_1.PathHelper.isDirectory(this._s3Object.key);
        },
        enumerable: true,
        configurable: true
    });
    Object.defineProperty(TerraStorageObject.prototype, "isFile", {
        get: function () {
            return path_helper_1.PathHelper.isFile(this._s3Object.key);
        },
        enumerable: true,
        configurable: true
    });
    ...
    TerraStorageObject.prototype.removeChild = function (key) {
        var paths = key.split('/').filter(function (path) { return path.length > 0; });
        var nextPath = paths.shift();
        var child = this.getChild(nextPath);
        if (child) {
            if (paths.length > 0) {
    ...
    TerraStorageObject.prototype.find = function (key) {
        ...
        var paths = key.split('/').filter(function (key) { return key.length > 0; });
        var nextPath = paths.shift();
        var child = this.getChild(nextPath);
