    ...
    TerraFileListComponent.prototype.ngOnInit = function () {
        ...
        this._parentFileBrowser.onSelectedUrlChange.subscribe(function (selectedUrl) {
            if (selectedUrl && _this._storageList) {
                var object_1 = _this._storageList.flatList.find(function (storage) { return storage.publicUrl === selectedUrl; });
                if (!util_1.isNullOrUndefined(object_1)) {
                    ...
                    _this._fileTableComponent.inputHighlightedRow = _this._fileTableRowList.find(function (r) { return r.value === object_1; });
                }
            }
        });
    };
