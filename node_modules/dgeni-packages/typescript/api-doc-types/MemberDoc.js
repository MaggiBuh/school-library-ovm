...
var MemberDoc = (function () {
    function MemberDoc(containerDoc, symbol, declaration, basePath, namespacesToInclude, isStatic) {
        ...
        this.decorators = getDecorators_1.getDecorators(this.declaration);
        this.type = getDeclarationTypeText_1.getDeclarationTypeText(this.declaration, this.namespacesToInclude);
