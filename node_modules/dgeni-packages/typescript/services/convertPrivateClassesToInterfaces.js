    ...
    exportDocs.forEach(function (exportDoc) {
        ...
        if (exportDoc.docType === 'class' && exportDoc.constructorDoc && exportDoc.constructorDoc.internal) {
            ...
            if (addInjectableReference) {
                ...
                var constExportDoc = new ConstExportDoc_1.ConstExportDoc(exportDoc.moduleDoc, exportDoc.symbol, exportDoc.basePath, exportDoc.typeChecker, exportDoc.namespacedToInclude);
